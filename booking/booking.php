...
<div class="ui attached message">
  <div class="header">Booking Info</div>
    <div class="header">Order Ref: <span style="color:red;font-size:15px"><?php echo $_SESSION[
        'ORDERREF'
    ]; ?> <a href='index.php'>Cancel Order</a></span> </div> 
...
<form class="ui form attached fluid loading segment" onsubmit="return contact(this)">
 ...
 <div class="field">
    <select required id="destination">
      ...
      <option>Mbabane to Manzini</option>
      <option>Manzini to Nhlangano</option>
	   <option>Manzini to Lomahhasha</option>
	    <option>Mbabane to Piggs Peak</option>
    </select>
  </div>   
  </div>
<div class="field">  
 <div class="field">
    <select name="gender" required id="travelclass">
      <option value="" selected disabled>--Mode Of Travel--</option>
      <option>Kombi</option>
      <option>Bus</option>
	   <option>Taxi</option>
    </select>
...
<div class="ui attached message">
  <div class="header">Validate Payment Information</div>
    <div class="header">Ticket ID: <span style="color:red;font-size:15px"><?php echo $_SESSION[
        'ORDERREF'
    ]; ?> <a href='index.php'>Cancel Order</a></span> </div> 
...
<div class="ui icon input">
  ...
  <div class="field"> 
<label>Confirm Amount(E)</label>

<div class="ui icon input">
  <input value="50.00" type="text" id="amount" readonly>
</div></div>
 <div style="text-align:center">
